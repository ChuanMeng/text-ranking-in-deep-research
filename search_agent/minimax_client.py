...
def run_conversation_with_tools(
    ...
    while iteration <= max_iterations:
        try:
            ...
            reasoning = response_message.content.split("</think>")[0].strip()
            content = response_message.content.split("</think>")[-1].strip()
            ...
            if response_message.tool_calls:
                ...
                # Only return if content is valid
                if not "minimax:tool_call" in content:
                ...
                for tool_call in tool_calls:
                    ...
                    if i + 1 < len(messages):
                        ...
                        if isinstance(next_item, dict) and next_item.get("role") == "tool":
                            if next_item.get("tool_call_id") == tool_call_id:
