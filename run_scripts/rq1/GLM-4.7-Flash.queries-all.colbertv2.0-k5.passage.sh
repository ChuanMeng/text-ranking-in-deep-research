...
OUT_DIR=./runs/${MODEL_NAME}/${QUERY_NAME}.colbertv2.0-q${MAX_QUERY_LENGTH}-d${MAX_DOCUMENT_LENGTH}-k${K}.${CORPUS_TYPE}-psgid
OUT_DOC_DIR=./runs/${MODEL_NAME}/${QUERY_NAME}.colbertv2.0-q${MAX_QUERY_LENGTH}-d${MAX_DOCUMENT_LENGTH}-k${K}.${CORPUS_TYPE}
