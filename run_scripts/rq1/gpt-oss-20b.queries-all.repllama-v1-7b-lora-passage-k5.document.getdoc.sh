...
INDEX_PATH=./indexes/index.repllama-v1-7b-lora-passage.document/corpus.pkl
...
OUT_DIR=./runs/${MODEL_NAME}-${REASONING_EFFORT}/${QUERY_NAME}.repllama-v1-7b-lora-passage-k${K}.${CORPUS_TYPE}.getdoc
