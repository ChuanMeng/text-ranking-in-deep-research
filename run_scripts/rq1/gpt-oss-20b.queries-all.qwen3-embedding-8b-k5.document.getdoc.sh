...
INDEX_PATH="./indexes/index.qwen3-embedding-8b.document/corpus.shard*.pkl"
...
OUT_DIR=./runs/${MODEL_NAME}-${REASONING_EFFORT}/${QUERY_NAME}.qwen3-embedding-8b-k${K}.${CORPUS_TYPE}.getdoc
