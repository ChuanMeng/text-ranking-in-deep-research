...
OUT_DIR=./runs/${MODEL_NAME}-${REASONING_EFFORT}/${QUERY_NAME}.splade-v3-d${RERANKING_DEPTH}-rank1-7b-k${K}.${CORPUS_TYPE}-psgid
OUT_DOC_DIR=./runs/${MODEL_NAME}-${REASONING_EFFORT}/${QUERY_NAME}.splade-v3-d${RERANKING_DEPTH}-rank1-7b-k${K}.${CORPUS_TYPE}
